...
import bd.entity.BDEntityKhandFarmer;
...
public class BDStructureKhandFarm extends BDStructureKhandStructure {
	private Block crop1Block;
	private Item seed1;
	private Block crop2Block;
	private Item seed2;

	public BDStructureKhandFarm(boolean flag) {
		super(flag);
	}
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		if (random.nextInt(4) == 0) {
			BDEntityKhandFarmer farmer = new BDEntityKhandFarmer(world);
