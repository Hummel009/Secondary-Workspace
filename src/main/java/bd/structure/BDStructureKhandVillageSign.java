...
public class BDStructureKhandVillageSign extends BDStructureKhandStructure {
	private String[] signText = LOTRNames.getHaradVillageName(new Random());

	public BDStructureKhandVillageSign(boolean flag) {
		super(flag);
	}
	...
	public BDStructureKhandVillageSign setSignText(String[] s) {
		signText = s;
		return this;
	}
}
