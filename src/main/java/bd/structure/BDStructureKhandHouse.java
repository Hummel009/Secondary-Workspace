...
public class BDStructureKhandHouse extends BDStructureKhandStructure {
	public BDStructureKhandHouse(boolean flag) {
		super(flag);
	}
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		this.placeChest(world, random, 6, 1, 0, LOTRMod.chestBasket, 5, BDChestContents.KHAND_HOUSE);
