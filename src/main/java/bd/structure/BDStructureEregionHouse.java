...
import bd.database.*;
import bd.entity.BDEntityEregionElf;
import lotr.common.*;
...
public class BDStructureEregionHouse extends LOTRWorldGenStructureBase2 {
	...
	public BDStructureEregionHouse(boolean flag) {
		super(flag);
	}

	protected LOTREntityElf createElf(World world) {
		return new BDEntityEregionElf(world);
	}
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		if (restrictions) {
			...
			for (int i14 = -4; i14 <= 4; ++i14) {
				for (int k14 = -1; k14 <= 14; ++k14) {
					j13 = getTopBlock(world, i14, k14) - 1;
					if (!isSurface(world, i14, j13, k14)) {
						return false;
					}
					if (j13 < minHeight) {
						minHeight = j13;
		...
		for (i13 = -3; i13 <= 3; ++i13) {
			for (k13 = 0; k13 <= 13; ++k13) {
				int j15;
				i22 = Math.abs(i13);
				for (j15 = 0; (j15 >= 0 || !isOpaque(world, i13, j15, k13)) && getY(j15) >= 0; --j15) {
					setBlockAndMetadata(world, i13, j15, k13, brickBlock, brickMeta);
					setGrassToDirt(world, i13, j15 - 1, k13);
				}
				for (j15 = 1; j15 <= 12; ++j15) {
					setAir(world, i13, j15, k13);
				}
				if (i22 <= 2 && k13 >= 1 && k13 <= 12) {
					setBlockAndMetadata(world, i13, 0, k13, stoneBlock, stoneMeta);
				}
				if (i22 > 2 || k13 != 0) {
					continue;
				}
				setBlockAndMetadata(world, i13, 0, k13, pillarBlock, pillarMeta);
			}
		}
		for (i13 = -3; i13 <= 3; ++i13) {
			i2 = Math.abs(i13);
			if (i2 % 2 == 1) {
				setBlockAndMetadata(world, i13, 1, 0, pillarBlock, pillarMeta);
				setBlockAndMetadata(world, i13, 2, 0, brickWallBlock, brickWallMeta);
				setBlockAndMetadata(world, i13, 3, 0, brickWallBlock, brickWallMeta);
				setBlockAndMetadata(world, i13, 4, 0, pillarBlock, pillarMeta);
				if (i2 == 1) {
					setBlockAndMetadata(world, i13, 5, 0, pillarBlock, pillarMeta);
				}
			}
			if (i2 == 0) {
				setBlockAndMetadata(world, i13, 6, 0, pillarBlock, pillarMeta);
				for (j14 = 7; j14 <= 9; ++j14) {
					setBlockAndMetadata(world, i13, j14, 0, brickWallBlock, brickWallMeta);
				}
				for (j14 = 10; j14 <= 11; ++j14) {
					setBlockAndMetadata(world, i13, j14, 0, pillarBlock, pillarMeta);
				}
				continue;
			}
			if (i2 > 2) {
			...
			setBlockAndMetadata(world, i13, 6, 0, brickWallBlock, brickWallMeta);
		}
		...
		for (j14 = 0; j14 < i2; ++j14) {
			int i16 = i15[j14];
			for (j13 = 1; j13 <= 4; ++j13) {
				setBlockAndMetadata(world, i16, j13, 1, pillarBlock, pillarMeta);
			}
			...
			for (j13 = 1; j13 <= 4; ++j13) {
				setBlockAndMetadata(world, i16, j13, 5, pillarBlock, pillarMeta);
				setBlockAndMetadata(world, i16, j13, 8, pillarBlock, pillarMeta);
			}
			...
			for (j13 = 1; j13 <= 4; ++j13) {
				setBlockAndMetadata(world, i16, j13, 12, pillarBlock, pillarMeta);
			}
		...
		for (i12 = -2; i12 <= 2; ++i12) {
			...
			case 0:
				for (j14 = 1; j14 <= 6; ++j14) {
					setBlockAndMetadata(world, i12, j14, 13, pillarBlock, pillarMeta);
				}
				for (j14 = 7; j14 <= 9; ++j14) {
					setBlockAndMetadata(world, i12, j14, 13, brickWallBlock, brickWallMeta);
				}
				for (j14 = 10; j14 <= 11; ++j14) {
					setBlockAndMetadata(world, i12, j14, 13, pillarBlock, pillarMeta);
				}
				break;
			case 1:
				setBlockAndMetadata(world, i12, 1, 13, brickStairBlock, 7);
				setBlockAndMetadata(world, i12, 3, 13, barsBlock, 0);
				setBlockAndMetadata(world, i12, 4, 13, plankStairBlock, 7);
				break;
			case 2:
				setBlockAndMetadata(world, i12, 1, 13, brickBlock, brickMeta);
				setBlockAndMetadata(world, i12, 2, 13, plankBlock, plankMeta);
				setBlockAndMetadata(world, i12, 3, 13, plankBlock, plankMeta);
				setBlockAndMetadata(world, i12, 4, 13, plankStairBlock, i12 > 0 ? 0 : 1);
				break;
			default:
				break;
			}
			...
			setBlockAndMetadata(world, i12, 5, 13, stoneSlabBlock, stoneSlabMeta | 8);
			setBlockAndMetadata(world, i12, 6, 13, brickWallBlock, brickWallMeta);
		}
		for (i12 = -2; i12 <= 2; ++i12) {
			for (k13 = 1; k13 <= 12; ++k13) {
				setBlockAndMetadata(world, i12, 5, k13, stoneBlock, stoneMeta);
			}
		}
		for (k1 = 0; k1 <= 13; ++k1) {
			...
			setBlockAndMetadata(world, -3, 6, k1, block, meta);
			setBlockAndMetadata(world, -3, 7, k1, block, meta);
			setBlockAndMetadata(world, -3, 8, k1, stairBlock, 1);
			setBlockAndMetadata(world, -2, 8, k1, stairBlock, 4);
			setBlockAndMetadata(world, -2, 9, k1, block, meta);
			setBlockAndMetadata(world, -2, 10, k1, stairBlock, 1);
			setBlockAndMetadata(world, -1, 10, k1, stairBlock, 4);
			setBlockAndMetadata(world, 4, 5, k1, stairBlock, 0);
			setBlockAndMetadata(world, 3, 5, k1, stairBlock, 5);
			setBlockAndMetadata(world, 3, 6, k1, block, meta);
			setBlockAndMetadata(world, 3, 7, k1, block, meta);
			setBlockAndMetadata(world, 3, 8, k1, stairBlock, 0);
			setBlockAndMetadata(world, 2, 8, k1, stairBlock, 5);
			setBlockAndMetadata(world, 2, 9, k1, block, meta);
			setBlockAndMetadata(world, 2, 10, k1, stairBlock, 0);
			setBlockAndMetadata(world, 1, 10, k1, stairBlock, 5);
			if (k1 <= 1 || k1 >= 12) {
				setBlockAndMetadata(world, -1, 11, k1, block, meta);
				setBlockAndMetadata(world, -1, 12, k1, stairBlock, 1);
				setBlockAndMetadata(world, 1, 11, k1, block, meta);
				setBlockAndMetadata(world, 1, 12, k1, stairBlock, 0);
				continue;
			}
			if (k1 <= 4 || k1 >= 9) {
			...
			if (k1 == 5) {
				setBlockAndMetadata(world, -1, 11, k1, stairBlock, 3);
				setBlockAndMetadata(world, 1, 11, k1, stairBlock, 3);
				continue;
			}
			if (k1 == 8) {
				setBlockAndMetadata(world, -1, 11, k1, stairBlock, 2);
				setBlockAndMetadata(world, 1, 11, k1, stairBlock, 2);
				continue;
			}
			setBlockAndMetadata(world, -1, 11, k1, slabBlock, slabMeta);
			setBlockAndMetadata(world, 1, 11, k1, slabBlock, slabMeta);
		}
		for (k1 = 0; k1 <= 13; ++k1) {
			setBlockAndMetadata(world, 0, 11, k1, brickBlock, brickMeta);
		}
		...
		for (j1 = 1; j1 <= 4; ++j1) {
			setBlockAndMetadata(world, -2, j1, 2, Blocks.bookshelf, 0);
		}
		...
		setBlockAndMetadata(world, 2, 4, 3, stoneSlabBlock, stoneSlabMeta | 8);
		for (j1 = 1; j1 <= 4; ++j1) {
			setBlockAndMetadata(world, 2, j1, 4, Blocks.bookshelf, 0);
		}
		for (i12 = -1; i12 <= 0; ++i12) {
			for (k13 = 2; k13 <= 3; ++k13) {
				setBlockAndMetadata(world, i12, 1, k13, Blocks.carpet, 3);
			}
		}
		int[] i17 = { 5, 8 };
		k13 = i17.length;
		...
		for (i1 = 0; i1 <= 1; ++i1) {
			for (k13 = 7; k13 <= 8; ++k13) {
				setBlockAndMetadata(world, i1, 1, k13, Blocks.carpet, 11);
			}
		}
		...
		if (leafy) {
			for (i1 = -2; i1 <= 2; ++i1) {
				for (k13 = 6; k13 <= 7; ++k13) {
					...
					setBlockAndMetadata(world, i1, 4, k13, leafBlock, leafMeta);
				}
			}
		}
		for (i1 = 0; i1 <= 1; ++i1) {
			for (k13 = 9; k13 <= 11; ++k13) {
				setAir(world, i1, 5, k13);
			}
		}
		for (i1 = -1; i1 <= 1; ++i1) {
			for (k13 = 1; k13 <= 9; ++k13) {
				setBlockAndMetadata(world, i1, 10, k13, brickSlabBlock, brickSlabMeta | 8);
			}
			for (k13 = 10; k13 <= 12; ++k13) {
				setBlockAndMetadata(world, i1, 9, k13, brickBlock, brickMeta);
				setBlockAndMetadata(world, i1, 10, k13, brickBlock, brickMeta);
			}
		}
		for (k12 = 9; k12 <= 12; ++k12) {
			for (j12 = 6; j12 <= 8; ++j12) {
				setBlockAndMetadata(world, 2, j12, k12, brickBlock, brickMeta);
			}
		}
		...
		for (i1 = 0; i1 <= 2; ++i1) {
			setBlockAndMetadata(world, i1, 6, 8, brickWallBlock, brickWallMeta);
		}
		for (i1 = -1; i1 <= 1; ++i1) {
			for (k13 = 1; k13 <= 7; ++k13) {
				i22 = Math.abs(i1);
				...
				if (i22 == 0 && k2 == 0) {
					setBlockAndMetadata(world, i1, 6, k13, Blocks.carpet, 0);
					continue;
				}
				if (i22 == 0 && k2 <= 2 || i22 == 1 && k2 == 0) {
					setBlockAndMetadata(world, i1, 6, k13, Blocks.carpet, 3);
					continue;
				}
				if ((i22 != 0 || k2 != 3) && (i22 != 1 || k2 != 1)) {
					continue;
				}
				setBlockAndMetadata(world, i1, 6, k13, Blocks.carpet, 11);
			}
		}
		int[] i19 = { -2, 2 };
		k13 = i19.length;
		...
		if (leafy) {
			for (int i111 = -4; i111 <= 4; ++i111) {
				for (k13 = 0; k13 <= 13; ++k13) {
					for (j14 = 5; j14 <= 12; ++j14) {
						if (Math.abs(i111) < 3 && j14 < 11 || random.nextInt(4) != 0 || !isAir(world, i111, j14, k13) || !isSolidRoofBlock(world, i111, j14 - 1, k13) && !isSolidRoofBlock(world, i111 - 1, j14, k13) && !isSolidRoofBlock(world, i111 + 1, j14, k13)) {
							continue;
						}
						setBlockAndMetadata(world, i111, j14, k13, leafBlock, leafMeta);
					}
				}
			}
		}
	...
	protected ItemStack getElfFramedItem(Random random) {
		ItemStack[] items = { new ItemStack(BDRegistry.eregion1_helmet), new ItemStack(BDRegistry.eregion1_chestplate), new ItemStack(BDRegistry.eregion1_leggings), new ItemStack(BDRegistry.eregion1_boots), new ItemStack(BDRegistry.eregion1_dagger), new ItemStack(BDRegistry.eregion1_sword), new ItemStack(BDRegistry.eregion1_spear), new ItemStack(BDRegistry.eregion1_dagger_poisoned), new ItemStack(BDRegistry.eregion1_bow), new ItemStack(Items.arrow), new ItemStack(Items.feather), new ItemStack(LOTRMod.swanFeather), new ItemStack(LOTRMod.quenditeCrystal), new ItemStack(LOTRMod.goldRing), new ItemStack(LOTRMod.silverRing) };
	...
	protected void setupRandomBlocks(Random random) {
		...
		brickSlabMeta = 5;
		brickStairBlock = WOTRMCNewBlocks.avariSquareStairs;
		...
		bannerType = LOTRItemBanner.BannerType.EREGION;
		chestContents = BDChestContents.EREGION_HALL;
	}
}
