...
public class BDStructureKhandBazaar extends BDStructureKhandStructure {
	private static Class[] stalls = { Mason.class, Butcher.class, Brewer.class, Fish.class, Baker.class, Goldsmith.class, Lumber.class, Hunter.class, Blacksmith.class, Farmer.class };

	public BDStructureKhandBazaar(boolean flag) {
		super(flag);
	}
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, -3, 4, -7, LOTRItemBanner.BannerType.KHAND, 2);
		placeWallBanner(world, 3, 4, -7, LOTRItemBanner.BannerType.KHAND, 2);
		placeWallBanner(world, -7, 10, -8, LOTRItemBanner.BannerType.KHAND, 2);
		placeWallBanner(world, -7, 10, -6, LOTRItemBanner.BannerType.KHAND, 0);
		placeWallBanner(world, -8, 10, -7, LOTRItemBanner.BannerType.KHAND, 3);
		placeWallBanner(world, -6, 10, -7, LOTRItemBanner.BannerType.KHAND, 1);
		placeWallBanner(world, 7, 10, -8, LOTRItemBanner.BannerType.KHAND, 2);
		placeWallBanner(world, 7, 10, -6, LOTRItemBanner.BannerType.KHAND, 0);
		placeWallBanner(world, 6, 10, -7, LOTRItemBanner.BannerType.KHAND, 3);
		placeWallBanner(world, 8, 10, -7, LOTRItemBanner.BannerType.KHAND, 1);
		for (int i1 : new int[] { -7, 7 }) {
			j1 = 1;
			int k1 = -11;
			BDEntityKhandWarrior guard = new BDEntityKhandWarrior(world);
	...
	private static class Baker extends LOTRWorldGenStructureBase2 {
		...
		public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
			...
			BDEntityKhandBaker trader = new BDEntityKhandBaker(world);
	...
	private static class Blacksmith extends LOTRWorldGenStructureBase2 {
		...
		public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
			...
			placeArmorStand(world, 1, 1, 2, 0, new ItemStack[] { null, new ItemStack(BDRegistry.khand1_chestplate), null, null });
			placeWeaponRack(world, 0, 2, 2, 1, new BDStructureKhandBazaar(false).getRandomKhandWeapon(random));
			placeWeaponRack(world, 3, 2, 2, 3, new BDStructureKhandBazaar(false).getRandomKhandWeapon(random));
			BDEntityKhandBlacksmith trader = new BDEntityKhandBlacksmith(world);
			spawnNPCAndSetHome(trader, world, 2, 1, 1, 4);
			return true;
		}
	}
	...
	private static class Brewer extends LOTRWorldGenStructureBase2 {
		...
		public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
			...
			BDEntityKhandBrewer trader = new BDEntityKhandBrewer(world);
			spawnNPCAndSetHome(trader, world, 2, 1, 1, 4);
			return true;
		}
	}
	...
	private static class Butcher extends LOTRWorldGenStructureBase2 {
		...
		public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
			...
			BDEntityKhandButcher trader = new BDEntityKhandButcher(world);
			spawnNPCAndSetHome(trader, world, 2, 1, 1, 4);
			return true;
		}
	}
	...
	private static class Farmer extends LOTRWorldGenStructureBase2 {
		...
		public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
			...
			BDEntityKhandFarmer trader = new BDEntityKhandFarmer(world);
			spawnNPCAndSetHome(trader, world, 2, 1, 1, 4);
			return true;
		}
	}
	...
	private static class Fish extends LOTRWorldGenStructureBase2 {
		...
		public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
			...
			BDEntityKhandFishmonger trader = new BDEntityKhandFishmonger(world);
			spawnNPCAndSetHome(trader, world, 2, 1, 1, 4);
			return true;
		}
	}
	...
	private static class Goldsmith extends LOTRWorldGenStructureBase2 {
		...
		public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
			...
			BDEntityKhandGoldsmith trader = new BDEntityKhandGoldsmith(world);
			spawnNPCAndSetHome(trader, world, 2, 1, 1, 4);
			return true;
		}
	}
	...
	private static class Hunter extends LOTRWorldGenStructureBase2 {
		...
		public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
			...
			BDEntityKhandHunter trader = new BDEntityKhandHunter(world);
			spawnNPCAndSetHome(trader, world, 2, 1, 1, 4);
			return true;
		}
	}
	...
	private static class Lumber extends LOTRWorldGenStructureBase2 {
		...
		public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
			...
			BDEntityKhandLumberman trader = new BDEntityKhandLumberman(world);
			spawnNPCAndSetHome(trader, world, 2, 1, 1, 4);
			return true;
		}
	}
	...
	private static class Mason extends LOTRWorldGenStructureBase2 {
		...
		public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
			this.setOriginAndRotation(world, i, j, k, rotation, 0);
			setBlockAndMetadata(world, 2, 1, 2, WOTRMCNewBlocks.khandbrickaligned, 0);
			setBlockAndMetadata(world, 2, 2, 2, LOTRMod.brick3, 13);
			placeFlowerPot(world, 0, 2, 2, getRandomFlower(world, random));
			placeWeaponRack(world, 3, 2, 2, 3, new ItemStack(LOTRMod.pickaxeBronze));
			BDEntityKhandMason trader = new BDEntityKhandMason(world);
			spawnNPCAndSetHome(trader, world, 2, 1, 1, 4);
			return true;
		}
	}
