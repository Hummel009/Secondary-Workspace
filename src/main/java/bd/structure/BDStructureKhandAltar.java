...
import bd.entity.BDEntityKhandMan;
import lotr.common.LOTRMod;
import net.minecraft.init.Blocks;
import net.minecraft.world.World;

public class BDStructureKhandAltar extends BDStructureKhandStructure {
	public BDStructureKhandAltar(boolean flag) {
		super(flag);
	}
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
				...
				for (k1 = -holeR; k1 <= holeR; ++k1) {
					...
					for (int j14 = 3; j14 >= -holeDHere; --j14) {
						...
						if (random.nextBoolean()) {
							...
							setBlockAndMetadata(world, i2, j2, k2, LOTRMod.wasteBlock, 0);
						}
		...
		BDEntityKhandMan gulfman = new BDEntityKhandMan(world);
		spawnNPCAndSetHome(gulfman, world, 0, 7, -1, 4);
		return true;
	}
}
