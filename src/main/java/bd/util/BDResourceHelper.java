...
public class BDResourceHelper {
	public static List<String> getAllSubFilePaths(ResourceLocation res, String... extensions) {
		ArrayList<String> list = new ArrayList<>();
		String baseStringPath = BDResourceHelper.getPath(res);
		ModContainer container = BDResourceHelper.getContainer(res);
	...
	public static InputStream getInputStream(ResourceLocation res) {
		return BDResourceHelper.getInputStream(BDResourceHelper.getContainer(res), BDResourceHelper.getPath(res));
	}
	...
	public static Map<String, InputStream> getInputStreams(ResourceLocation res, String... extensions) {
		...
		for (Map.Entry<String, ResourceLocation> entry : BDResourceHelper.getSubFileResourceLocations(res, extensions).entrySet()) {
			map.put(entry.getKey(), BDResourceHelper.getInputStream(entry.getValue()));
		}
		return map;
	}
	...
	public static Map<String, ResourceLocation> getSubFileResourceLocations(ResourceLocation res, String... extensions) {
		...
		String basePath = BDResourceHelper.getPath(res);
		for (String file : BDResourceHelper.getAllSubFilePaths(res, extensions)) {
