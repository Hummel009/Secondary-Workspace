...
public class BDCommander {
	...
	public static void addBrewingRecipe(ItemStack result, Object... ingredients) {
		findAndInvokeMethod(new Object[] { result, ingredients }, LOTRBrewingRecipes.class, (LOTRBrewingRecipes) null, "addBrewingRecipe", ItemStack.class, Object[].class);
	}
	...
	private static <T, E> T findAndInvokeMethod(Object[] arg, Class<? super E> clazz, E instance, String methodName, Class<?>... methodTypes) {
		return BDCommander.findAndInvokeMethod(arg, clazz, instance, new String[] { methodName }, methodTypes);
	}
