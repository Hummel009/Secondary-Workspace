...
public class LOTRBiomeGenOcean extends LOTRBiome {
	...
	public void decorate(World world, Random random, int i, int k) {
		...
		if (i < LOTRWaypoint.MITHLOND_SOUTH.getXCoord() && k > LOTRWaypoint.SOUTH_FOROCHEL.getZCoord() && k < LOTRWaypoint.THARBAD.getZCoord() && random.nextInt(200) == 0) {
		...
		if (k >= 64000) {
			float chance = k >= 130000 ? 1.0f : (k - 64000) / 66000.0f;
