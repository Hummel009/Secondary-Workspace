...
public class LOTRSpawnList {
	public static final LOTRSpawnList EREGION_ELVES = new LOTRSpawnList(new LOTRSpawnEntry(BDEntityEregionElf.class, 10, 4, 6));
	public static final LOTRSpawnList EREGION_WARRIORS = new LOTRSpawnList(new LOTRSpawnEntry(BDEntityEregionWarrior.class, 10, 4, 4));
	...
	public static final LOTRSpawnList BREE_MEN = new LOTRSpawnList(new LOTRSpawnEntry(LOTREntityBreeMan.class, 10, 4, 6));
	...
	public static final LOTRSpawnList KHANDS = new LOTRSpawnList(new LOTRSpawnEntry(BDEntityKhandMan.class, 20, 2, 4));
	public static final LOTRSpawnList KHAND_WARRIORS = new LOTRSpawnList(new LOTRSpawnEntry(BDEntityKhandLevyman.class, 20, 2, 4), new LOTRSpawnEntry(BDEntityKhandWarrior.class, 10, 3, 6), new LOTRSpawnEntry(BDEntityKhandArcher.class, 5, 3, 6));
