...
public class LOTREntityCrossbowBolt extends LOTREntityProjectileBase {
	...
	protected void onCollideWithTarget(Entity entity) {
		...
		if (!worldObj.isRemote && entity instanceof EntityLivingBase && (itemstack = getProjectileItem()) != null && (item = itemstack.getItem()) instanceof LOTRItemCrossbowBolt && ((LOTRItemCrossbowBolt) item).isFire) {
			BDEventHandler.applyStandardFire((EntityLivingBase) entity);
		}
		if (!worldObj.isRemote && entity instanceof EntityLivingBase && (itemstack = getProjectileItem()) != null && (item = itemstack.getItem()) instanceof LOTRItemCrossbowBolt && ((LOTRItemCrossbowBolt) item).isHunger) {
			BDEventHandler.applyStandardHunger((EntityLivingBase) entity);
		}
		if (!worldObj.isRemote && entity instanceof EntityLivingBase && (itemstack = getProjectileItem()) != null && (item = itemstack.getItem()) instanceof LOTRItemCrossbowBolt && ((LOTRItemCrossbowBolt) item).isBlindness) {
			BDEventHandler.applyStandardBlindness((EntityLivingBase) entity);
		}
		if (!worldObj.isRemote && entity instanceof EntityLivingBase && (itemstack = getProjectileItem()) != null && (item = itemstack.getItem()) instanceof LOTRItemCrossbowBolt && ((LOTRItemCrossbowBolt) item).isSlowness) {
			BDEventHandler.applyStandardSlowness((EntityLivingBase) entity);
		}
