...
public class LOTRItemBanner extends Item {
			...
			if (block.isSideSolid(world, i, j - 1, k, ForgeDirection.UP)) {
				...
				if (!world.isRemote) {
					...
					if (world.checkNoEntityCollision(banner.boundingBox) && world.getCollidingBoundingBoxes(banner, banner.boundingBox).size() == 0 && !world.isAnyLiquid(banner.boundingBox) && world.getEntitiesWithinAABB(LOTREntityBanner.class, banner.boundingBox).isEmpty()) {
						...
						if (banner.getPlacingPlayer() == null || !LOTRItemBanner.shouldKeepOriginalOwnerOnPlacement(entityplayer, itemstack)) {
	...
	public static boolean shouldKeepOriginalOwnerOnPlacement(EntityPlayer entityplayer, ItemStack bannerItem) {
		return LOTRItemBanner.hasChoiceToKeepOriginalOwner(entityplayer) && entityplayer.isSneaking();
	}

	public enum BannerType {
		GONDOR(0, "gondor", LOTRFaction.GONDOR), ROHAN(1, "rohan", LOTRFaction.ROHAN), MORDOR(2, "mordor", LOTRFaction.MORDOR), GALADHRIM(3, "lothlorien", LOTRFaction.LOTHLORIEN), WOOD_ELF(4, "mirkwood", LOTRFaction.WOOD_ELF), DUNLAND(5, "dunland", LOTRFaction.DUNLAND), ISENGARD(6, "isengard", LOTRFaction.ISENGARD), DWARF(7, "durin", LOTRFaction.DURINS_FOLK), ANGMAR(8, "angmar", LOTRFaction.ANGMAR), NEAR_HARAD(9, "nearHarad", LOTRFaction.NEAR_HARAD), HIGH_ELF(10, "highElf", LOTRFaction.HIGH_ELF), BLUE_MOUNTAINS(11, "blueMountains", LOTRFaction.BLUE_MOUNTAINS), RANGER_NORTH(12, "ranger", LOTRFaction.RANGER_NORTH), DOL_GULDUR(13, "dolGuldur", LOTRFaction.DOL_GULDUR), GUNDABAD(14, "gundabad", LOTRFaction.GUNDABAD), HALF_TROLL(15, "halfTroll", LOTRFaction.HALF_TROLL), DOL_AMROTH(16, "dolAmroth", LOTRFaction.GONDOR), MOREDAIN(17, "moredain", LOTRFaction.MORWAITH), TAUREDAIN(18, "tauredain", LOTRFaction.TAURETHRIM), DALE(19, "dale", LOTRFaction.DALE), DORWINION(20, "dorwinion", LOTRFaction.DORWINION), HOBBIT(21, "hobbit", LOTRFaction.HOBBIT), ANORIEN(22, "anorien", LOTRFaction.GONDOR), ITHILIEN(23, "ithilien", LOTRFaction.GONDOR), LOSSARNACH(24, "lossarnach", LOTRFaction.GONDOR), LEBENNIN(25, "lebennin", LOTRFaction.GONDOR), PELARGIR(26, "pelargir", LOTRFaction.GONDOR), BLACKROOT_VALE(27, "blackrootVale", LOTRFaction.GONDOR), PINNATH_GELIN(28, "pinnathGelin", LOTRFaction.GONDOR), MINAS_MORGUL(29, "minasMorgul", LOTRFaction.MORDOR), BLACK_URUK(30, "blackUruk", LOTRFaction.MORDOR), GONDOR_STEWARD(31, "gondorSteward", LOTRFaction.GONDOR), NAN_UNGOL(32, "nanUngol", LOTRFaction.MORDOR), RHUDAUR(33, "rhudaur", LOTRFaction.ANGMAR), LAMEDON(34, "lamedon", LOTRFaction.GONDOR), RHUN(35, "rhun", LOTRFaction.RHUDEL), RIVENDELL(36, "rivendell", LOTRFaction.HIGH_ELF), ESGAROTH(37, "esgaroth", LOTRFaction.DALE), UMBAR(38, "umbar", LOTRFaction.NEAR_HARAD), HARAD_NOMAD(39, "haradNomad", LOTRFaction.NEAR_HARAD), HARAD_GULF(40, "haradGulf", LOTRFaction.NEAR_HARAD), BREE(41, "bree", LOTRFaction.BREE), EREGION(42, "eregion", LOTRFaction.EREGION), BANNERCOLOR_BLACK(43, "BANNERCOLOR_BLACK", LOTRFaction.UNALIGNED), BANNERCOLOR_BLUE(44, "BANNERCOLOR_BLUE", LOTRFaction.UNALIGNED), BANNERCOLOR_BROWN(45, "BANNERCOLOR_BROWN", LOTRFaction.UNALIGNED), BANNERCOLOR_CYAN(46, "BANNERCOLOR_CYAN", LOTRFaction.UNALIGNED), BANNERCOLOR_GRAY(47, "BANNERCOLOR_GRAY", LOTRFaction.UNALIGNED), BANNERCOLOR_GREEN(48, "BANNERCOLOR_GREEN", LOTRFaction.UNALIGNED), BANNERCOLOR_LIGHTBLUE(49, "BANNERCOLOR_LIGHTBLUE", LOTRFaction.UNALIGNED), BANNERCOLOR_LIGHTGRAY(50, "BANNERCOLOR_LIGHTGRAY", LOTRFaction.UNALIGNED), BANNERCOLOR_LIME(51, "BANNERCOLOR_LIME", LOTRFaction.UNALIGNED), BANNERCOLOR_MAGENTA(52, "BANNERCOLOR_MAGENTA", LOTRFaction.UNALIGNED), BANNERCOLOR_ORANGE(53, "BANNERCOLOR_ORANGE", LOTRFaction.UNALIGNED), BANNERCOLOR_PINK(54, "BANNERCOLOR_PINK", LOTRFaction.UNALIGNED), BANNERCOLOR_PURPLE(55, "BANNERCOLOR_PURPLE", LOTRFaction.UNALIGNED), BANNERCOLOR_RED(56, "BANNERCOLOR_RED", LOTRFaction.UNALIGNED), BANNERCOLOR_WHITE(57, "BANNERCOLOR_WHITE", LOTRFaction.UNALIGNED), BANNERCOLOR_YELLOW(58, "BANNERCOLOR_YELLOW", LOTRFaction.UNALIGNED), KHAND(59, "khand", LOTRFaction.KHAND);
