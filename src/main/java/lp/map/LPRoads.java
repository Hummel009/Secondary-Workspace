...
public class LPRoads {
	public static void preInit() {
		...
		LPCommander.registerRoad("Sus", LOTRWaypoint.CARN_DUM, LPWaypoint.Angsul, LPWaypoint.Kargasz);
		LPCommander.registerRoad("Sus", LPWaypoint.Szeldan, LPWaypoint.Litasz);
		LPCommander.registerRoad("Sus", LPWaypoint.Morkat, LPWaypoint.Szeldan);
		LPCommander.registerRoad("Sus", LPWaypoint.Eldanor, LPWaypoint.Kargasz, LPWaypoint.Morkat);
		LPCommander.registerRoad("Sus", LPWaypoint.KametBrin, LPWaypoint.Hojra);
		LPCommander.registerRoad("Sus", LPWaypoint.Eldanor, LPWaypoint.MorvaTart, LPWaypoint.Ettenmurs);
		LPCommander.registerRoad("Sus", LOTRWaypoint.LAST_BRIDGE, LPWaypoint.Hojra, LPWaypoint.Ettenmurs);
		LPCommander.registerRoad("Sus", LOTRWaypoint.LAST_BRIDGE, LPWaypoint.Fandar, LPWaypoint.DorTalion);
		LPCommander.registerRoad("Sus", LOTRWaypoint.GREENWAY_CROSSROADS, LPWaypoint.Argond, LPWaypoint.Undmond);
		LPCommander.registerRoad("Sus", LPWaypoint.Argond, LPWaypoint.Balost, LPWaypoint.Talsir);
		LPCommander.registerRoad("Sus", LOTRWaypoint.ERYN_VORN, new int[] { 811, 921 }, LPWaypoint.Talsir);
		LPCommander.registerRoad("Sus", LPWaypoint.Gitrenor, LOTRWaypoint.SARN_FORD);
		LPCommander.registerRoad("Sus", LPWaypoint.AnnonBaran, LPWaypoint.Gitrenor);
		LPCommander.registerRoad("Sus", LPWaypoint.Gitrenor, new int[] { 700, 921 }, LOTRWaypoint.HARLINDON);
